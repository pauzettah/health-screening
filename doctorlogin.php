...
<body>
    ...
    <div class="form-container"> <!-- Form container -->
        <form action="validatedoctor.php" method="GET">
            <div class="text">
                <h2>Login Form</h2>
            </div>
            <br>
           ...
           <a href="projectdirectordash.php"><button type="submit" id="loginButton">LOGIN</button></a> 
            <div class="forget">
                <a href="forgotpwd.html">Forgot Password</a><br><br>
                <hr>
                <p>New user? Create an account <a href="register.php">Here</a></p>
            </div>
        </form>
    </div>
